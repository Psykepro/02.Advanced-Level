...
(function(factory){
  ...
  $.extend(Sammy.Object.prototype, {
    ...
    // Escape HTML in string, use in template to prevent script injection.
    // Also aliased as `h()`
...
$.extend(Sammy.DefaultLocationProxy.prototype , {
  ...
  Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    // whenever you're inside of an event context (template, routes, bind).
    //
    // ### Example
    //
    //     var app = $.sammy(function() {
    ...
    // a simple global cache for template. Uses the same semantics as
  ...
  // even with remote calls to fetch template.
  //
  ...
  Sammy.RenderContext.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    // This is useful for nesting template as part of the initial page load wrapped
    // in invisible elements or `<script>` tags. With template paths, the template
    // engine is looked up by the extension. For DOM/jQuery embedded template,
  ...
  Sammy.EventContext.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    // preloading/caching the template.
    load: function(location, options, callback) {
