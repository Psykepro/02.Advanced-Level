...
(function (eventSystem) {
    ...
    dynamicallyАddOptions(select);

	function dynamicallyАddOptions(select){
        var optionsFragment = document.createDocumentFragment();
        eventSystem.halls.forEach(function(currentHall){
            var currentOption = document.createElement('option');
            currentOption.value = currentHall.getName();
            currentOption.text = currentHall.getName();
            optionsFragment.appendChild(currentOption);
        });
