...
var shapeModule =(function(){
    ...
    function validateCenterPoint(centerX, centerY){
        if((isNaN(centerX) || centerX === undefined) || (isNaN(centerY) || centerY === undefined)){
    ...
    var Circle = (function (){
        function Circle(color, centerX, centerY, r){
            ...
            validateRadius(r);
            validateCenterPoint(centerX, centerY);
    ...
    var Rectangle = (function (){
        ...
        function validateTopLeftCorner(topLeftX, topLeftY){
            if((isNaN(topLeftX) || topLeftX === undefined) || (isNaN(topLeftY) || topLeftY === undefined)){
                throw new Error('Invalid point.');
            }
        }
        ...
        function Rectangle(color, topLeftX, topLeftY, width, height){
            ...
            validateTopLeftCorner(topLeftX, topLeftY);
    ...
    var Triangle = (function (){
        function validatePoint(pX, pY) {
            if((isNaN(pX) || pX === undefined) || (isNaN(pY) || pY === undefined)){
                throw new Error('Invalid point.');
            }
        }
